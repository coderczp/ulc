...
public class NewAsynIndexManager implements AutoCloseable, FileChangeListener {
	...
	private static final Logger log = LoggerFactory.getLogger(NewAsynIndexManager.class);

	public NewAsynIndexManager(File baseDir, File indexBaseDir, LogIndexHandler handler) {
